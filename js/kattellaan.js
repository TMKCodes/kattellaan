			...
			result_display += '<div class="row">';
				...
				result_display += '<div class="col-xs-8">';
					...
					result_display += '<div>';
						...
						result_display += '<button class="btn btn-success" id="search-result-add-friend" style="display: inline-block;" disabled="disabled"><i class="uid" style="display: none;">' + result[i].id + '</i>Pyydä ystäväksi</button>";
